...
#define OS_EVENT_TYPE_KEYBOARD_KEYUP  0x0103

#define OS_EVENT_TYPE_POINTER_MOVE      0x0201
#define OS_EVENT_TYPE_POINTER_CLICK     0x0202
#define OS_EVENT_TYPE_POINTER_KEYDOWN   0x0203
#define OS_EVENT_TYPE_POINTER_KEYUP   0x0204
